...
Type of  containers options: -PROV, -DEBUG, -TECH, -CUSTOM or [not specified]
    -PROV = Predix Machine container with provision
    -DEBUG = Predix Machine default container with web console
    -TECH = Predix Machine container with technician console
    -CUSTOM <img file full path> = Generate container based on custom image file. 
